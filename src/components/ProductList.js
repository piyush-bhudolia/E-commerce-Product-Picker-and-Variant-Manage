...
const ProductList = () => {
  const [products, setProducts] = useState([
    { id: 1, name: 'Cotton Classic Sneaker', discount: 20, type: 'percentage', variants: ['Size 9', 'Size 10'], showVariants: false }
  ]);
        ...
        <div key={product.id}>
            ...
            <div className="column">
              <div className="product-row">
                ...
                <div className="product-info">
                  ...
                  <button className="edit-button" onClick={() => openProductPicker(index)}>✏️</button>
                </div>
              </div>
            </div>
            <div className="column">
          ...
          {product.variants.length > 0 && (
            <div className="show-variants-container">
              <button className="show-variants" onClick={() => toggleVariants(index)}>
          ...
          {/* Variants section */}
          {product.showVariants && product.variants.map((variant, variantIndex) => (
            <div className="variant-row columns" key={`${product.id}-${variantIndex}`}>
              <div className="column">
                <div className="product-row">
